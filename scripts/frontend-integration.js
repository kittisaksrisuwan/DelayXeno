 ...
 * This file demonstrates how to integrate Delayxeno with a web frontend
 */

// For React/Vue/Angular applications
export class DelayxenoClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new DelayxenoClient(provider, contractAddress);
